...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    content: "Zain made the process so easy. I was worried about the tech, but he handled everything. I finally have a professional presence that brings in real calls.",
    avatar: "/avatar1.png",
  },
  {
    id: "t2",
    name: "Sarah Jenkins",
    role: "Agency Founder",
    content: "My business felt invisible before. Now, we are ranking on Google and the booking system Zain built is like having a second employee who never sleeps.",
    avatar: "/avatar2.png",
  },
  {
    id: "t3",
    name: "Mike Ross",
    role: "Retailer",
    content: "Reliable and fast. If you're looking for someone who understands business results and not just code, Zain is your guy.",
    avatar: "/avatar3.png",
  }
];
