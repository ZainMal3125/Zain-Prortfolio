        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          >
            ...
            <div className="bg-indigo-50 dark:bg-indigo-900/10 p-6 rounded-2xl border border-indigo-100 dark:border-indigo-900/20 mb-8 max-w-lg">
              <div className="flex gap-4 items-start">
                ...
                <p className="text-sm text-slate-700 dark:text-slate-300">
                  <strong>The Zain Guarantee:</strong> I only work with businesses where I can guarantee measurable results. If I don't think I can help you, I'll tell you honestly.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <a href="mailto:zainmehboob6788@gmail.com" className="flex items-center gap-4 text-slate-600 dark:text-slate-400 hover:text-indigo-600 transition-colors">
                <Mail size={20} className="text-indigo-500" /> zainmehboob6788@gmail.com
              </a>
              <a href="https://wa.me/923259914121" className="flex items-center gap-4 text-slate-600 dark:text-slate-400 hover:text-indigo-600 transition-colors">
                <MessageCircle size={20} className="text-indigo-500" /> +92 314 658 9641
              </a>
            </div>
          </motion.div>
