...
export const PortfolioHero: React.FC = () => {
  ...
  // Section 1: 15% - 30% (Bottom Left) — "Zain Malik."
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-16 lg:gap-24 w-full">
            ...
            <div className="w-full lg:w-[60%] text-center lg:text-left">
              ...
              <motion.h1
                ...
                animate="visible"
              >
                {["Hi!", "My", "name", "is", "Zain,", "A", "Full", "Stack", "Developer"].map((word, index) => (
                  <motion.span
                    key={index}
                    variants={{
              ...
              >
                <a href="https://github.com/ZainMal3125" target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white hover:bg-[#2b3137] hover:text-white dark:hover:bg-white dark:hover:text-slate-900 transition-all duration-300 hover:scale-110 hover:shadow-lg shadow-slate-200 dark:shadow-none" aria-label="GitHub">
                  <Github size={24} />
                </a>
                <a href="https://www.linkedin.com/in/muhammad-zain-mehboob-595000386" target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 text-[#0077b5] hover:bg-[#0077b5] hover:text-white transition-all duration-300 hover:scale-110 hover:shadow-lg shadow-blue-200 dark:shadow-none" aria-label="LinkedIn">
                  <Linkedin size={24} />
                </a>
                <a href="mailto:zainmehboob6788@gmail.com" className="w-12 h-12 flex items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 text-[#ea4335] hover:bg-[#ea4335] hover:text-white transition-all duration-300 hover:scale-110 hover:shadow-lg shadow-red-200 dark:shadow-none" aria-label="Email">
                  <Mail size={24} />
                </a>
              </motion.div>
            </div>
