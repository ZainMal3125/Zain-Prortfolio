        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-slate-600 dark:text-slate-400 leading-relaxed font-light">
              <p>
                Hi, I'm Zain, a freelance tech builder based in <strong className="text-slate-900 dark:text-white font-semibold">Islamabad, Pakistan</strong>. I specialize in creating AI-powered automations, modern responsive websites, and custom web applications tailored for small businesses and startups.
              </p>
              <p>
