        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <a href="mailto:zainmehboob6788@gmail.com" className="flex items-center gap-4 text-slate-600 dark:text-slate-400 group">
                ...
                <div>
                  ...
                  <p>zainmehboob6788@gmail.com</p>
                </div>
              </a>

              <a href="https://wa.me/923146589641" className="flex items-center gap-4 text-slate-600 dark:text-slate-400 group">
                <div className="w-12 h-12 rounded-full bg-indigo-50 dark:bg-indigo-900/20 flex items-center justify-center text-indigo-600 dark:text-indigo-400 group-hover:bg-indigo-600 group-hover:text-white transition-colors">
                  <Phone size={24} />
                </div>
                <div>
